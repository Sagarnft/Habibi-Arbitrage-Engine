...
function pairCategory(chain, tokenInSymbol, tokenOutSymbol) {
...
export function getExecutablePairs(chain) {
    return buildCatalog(chain);
}
export function buildTradeStep(pair, amountIn) {
    return {
        dex: pair.dex,
...
export function ensurePairExecutionReady(pair) {
